...
public class DisplayModel extends Widget
{
    ...
    /** 'auto_zoom_to_fit_all' property: when true, the runtime auto-zooms to fit the display on load */
    public static final WidgetPropertyDescriptor<Boolean> propAutoZoomToFitAll = newBooleanPropertyDescriptor(WidgetPropertyCategory.MISC, "auto_zoom_to_fit_all", Messages.WidgetProperties_AutoZoomToFitAll);
    ...
    private volatile WidgetProperty<Boolean> autoZoomToFitAll;
    ...
    protected void defineProperties(final List<WidgetProperty<?>> properties)
    {
        ...
        properties.add(autoZoomToFitAll = propAutoZoomToFitAll.createProperty(this, false));
    ...
    /** @return 'auto_zoom_to_fit_all' property:
     *          when true, the display runtime will auto-zoom to fit the whole display on load
     */
    public WidgetProperty<Boolean> propAutoZoomToFitAll()
    {
        return autoZoomToFitAll;
    }
